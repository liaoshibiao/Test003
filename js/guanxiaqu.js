	  ...
	  var twodata=[];
	var erji=[];
	 var abc = "http://report.offline.qingger.com:8188/bi_yhj/REALLY/bi/report/params/queryOrgInfo/query";
     	var params = {
		"userId": '15975531236'
	};
    var cx_a=[];
		...
		for(var i=0;i<obj.data.list.length;i++){
			...
			//管辖区域第一层
			  $("#managementup div").bind("click",function(){
						...
						$(this).find('.qu_yu').css("background","url(./images/sjx_s.png)")
			            $(this).siblings('div').find('.qu_yu').css("background","url(./images/sjx_k.png)")
			          if(index!=0){
